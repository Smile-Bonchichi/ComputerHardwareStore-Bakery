...
<head>
    ...
    <title>Магазин компьютерной техники: Мобильные телефоны</title>
...
<div class="container">
    ...
    <p> В этом разделе вы найдёте самые популярные мобильные телефонамы по отличным ценам! </p>
    <div class="row">
    ...
    <div class="thumbnail">
        ...
        <div class="caption">
            ...
            <form action="http://internet-shop.tmweb.ru/basket/add/3" method="POST">
                ...
                <input type="hidden" name="_token" value="olbqlmFBdMvBczBNUUFBgUAtFSkKaz8yXLUWAVWy">            </form>
            </p>
        </div>
    </div>
</div>
