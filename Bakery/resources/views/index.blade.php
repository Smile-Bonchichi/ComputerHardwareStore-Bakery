...
<head>
    ...
    <title>Магазин компьютерной техники: Пекарня</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="http://internet-shop.tmweb.ru">Магазин компьютерной техники: Пекарня</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="http://internet-shop.tmweb.ru">Все товары</a></li>
                <li ><a href="http://internet-shop.tmweb.ru/categories">Категории</a> </li>
    ...
    <div class="starter-template">
        ...
        <div class="filters row">
            ...
            <div class="col-sm-2 col-md-2">
                <label for="hit"> <input type="checkbox" name="hit" id="hit">Хит</label>
            </div>
            <div class="col-sm-2 col-md-2">
                <label for="new"> <input type="checkbox" name="new" id="new">Новинка</label>
            </div>
            <div class="col-sm-2 col-md-2">
                <label for="recommend"> <input type="checkbox" name="recommend" id="recommend">Рекомендуем</label>
            </div>
            <div class="col-sm-6 col-md-3">
        ...
        <div class="caption">
            ...
            <p>
                <form action="http://internet-shop.tmweb.ru/basket/add/4" method="POST">
                    Не доступен <a href="http://internet-shop.tmweb.ru/mobiles/iphone_5se" class="btn btn-default" role="button">Подробнее</a>
                    <input type="hidden" name="_token" value="olbqlmFBdMvBczBNUUFBgUAtFSkKaz8yXLUWAVWy">            
                </form>
            </p>
        </div>
